...
void FetchPreKeyBundle(unsigned char *bob_id_public_key, unsigned char *bob_spk_public_key, unsigned char *bob_spk_signature){};
void Encode(const unsigned char *value){};

int main() {
    unsigned char bob_id_public_key[32];
