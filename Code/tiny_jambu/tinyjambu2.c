...
int main(void){
    // variables
    const size_t SAMPLE_ARR_SIZE = (24);
    unsigned char sampleArr[SAMPLE_ARR_SIZE] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x01, 0x02, 0x03};
    // const unsigned char m[] = sampleArr;                                      
    // unsigned long long mlen = SAMPLE_ARR_SIZE ;                                                // plaintext length
    ...
    encrypt(sampleArr, SAMPLE_ARR_SIZE, k);
    decrypt(c, clen, k);
    return 0;
}
void encrypt(const unsigned char* m, unsigned long long mlen, const unsigned char* k){
